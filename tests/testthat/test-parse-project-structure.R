...
test_that("`parse_project_structure()` works with 'demo-proj-source.yaml'", {
  ...
  expected <- data.frame(
    ...
    source = c("inst/source-files/sample.Renviron","inst/source-files/README.md",NA,
               "inst/source-files/R/temp_import_data.R",
               "inst/source-files/R/temp_clean_data.R",NA,"inst/source-files/data",NA,
               "inst/source-files/reports",NA),
